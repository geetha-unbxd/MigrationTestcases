...
/**
 * Drop-in replacement for org.fluentlenium.core.FluentPage.
 * Page objects (UiBase, etc.) extend this instead of FluentPage.
 */
public class PageBase implements Fluent {
    private WebDriver driver;

    void setDriverInternal(WebDriver driver) {
        this.driver = driver;
    }
    ...
    /**
     * FluentLenium's $() shorthand for find().
     */
    ...
    /**
     * Click by CSS selector (FluentLenium compatibility).
     */
    ...
    /**
     * Fill by CSS selector (FluentLenium compatibility).
     */
    ...
    /**
     * No-op clear for chaining compatibility (e.g. click(element).clear()).
     */
    public Fluent clear() {
        return this;
    }
